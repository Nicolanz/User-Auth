...
/**
 * @description To create a file profile of the authenticated User
...
/**
 * @description To get autheticated user's profile
    ...
    try {
        ...
        if (!profile){
            return res.status(404).json({
                success: false,
                message: "Your profile is not avilable"
            });
        }
...
/**
 * @description To update get user's profile with the username
 * @api /profiles/api/update-profile
 * @access Public
 * @type GET
 */
